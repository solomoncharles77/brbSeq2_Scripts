...
file_to_check="/lustre/alice3/scratch/vasccell/cs806/brbSeq/brbSeq2/brbSeq2_Scripts/allSeq2.txt"
...
while [ "$(find /lustre/alice3/scratch/vasccell/cs806/brbSeq/brbSeq2/mappedReads/ -name "*Aligned.out.sam" | wc -l)" -lt "$(wc -l /lustre/alice3/scratch/vasccell/cs806/brbSeq/brbSeq2/brbSeq2_Scripts/allSeq2.txt | awk '{print $1}')" ]
do
sleep 1h
done

# Get a file list for samtools
find /lustre/alice3/scratch/vasccell/cs806/brbSeq/brbSeq2/mappedReads/ -name "*Aligned.out.sam" -exec basename {} \; > allSam.txt
